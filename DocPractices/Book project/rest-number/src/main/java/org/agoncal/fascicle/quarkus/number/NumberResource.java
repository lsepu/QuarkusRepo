...
public class NumberResource {
  ...
  @Operation(summary = "Generates book numbers", description = "These book umbers have several formats: ISBN, ASIN and EAN")
  ...
  public Response generateBookNumbers() throws InterruptedException {
    ...
    bookNumbers.setIsbn10(faker.code().isbn10(true));
    bookNumbers.setIsbn13(faker.code().isbn13(true));
